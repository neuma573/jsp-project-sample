...
CREATE TABLE `BOARD` (
  ...
  `BOARD_DEL_DT` datetime DEFAULT NULL COMMENT '삭제일',
  `BOARD_VIEW` int(11) COLLATE utf8mb3_unicode_ci DEFAULT NULL COMMENT '조회수',
  `BOARD_COMMENT` int(11) DEFAULT NULL COMMENT '댓글수',
  `BOARD_LIKES` int(11)  NOT NULL COMMENT '추천수',
  PRIMARY KEY (`BOARD_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci COMMENT='게시판';
...
CREATE TABLE `COMMENT` (
  ...
  `COMMENT_MOD_DT` datetime DEFAULT NULL COMMENT '수정일',
  `COMMENT_DEL_DT` datetime DEFAULT NULL COMMENT '삭제일',
  `COMMENT_LIKES` int(11)  NOT NULL COMMENT '추천수',
